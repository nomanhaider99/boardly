...
export default function WorkspaceError({
  ...
  return (
    <div className="flex flex-1 flex-col items-center justify-center text-center px-4 py-20">
      <h2 className="font-heading text-xl font-bold mb-2">Failed to load workspace</h2>
      <p className="text-muted-foreground text-sm mb-6 max-w-xs">
        Something went wrong loading this workspace. Try again or return to your dashboard.
      </p>
